...
void wallAlign();
void JINXData();
#define D_BUMP_READY 10
#define M_FL 2
#define M_FR 3
#define M_RL 4
#define M_RR 5

#define D_ULTRASONIC_L_IN  3
#define D_ULTRASONIC_L_OUT 2
#define D_ULTRASONIC_R_IN  5
#define D_ULTRASONIC_R_OUT 4

#define D_ENC_LEFT_LOW 6
#define D_ENC_LEFT_HIGH 7
#define D_ENC_RIGHT_LOW 8
#define D_ENC_RIGHT_HIGH 9

#define D_LED_GREEN 11
#define D_LED_RED 12
